...
API_HASH = "067b1530fc64eea70b0a5377c9b493de"
bot_token= "5084842598:AAGwYW78ruhsh6Vx4bCx_SwAG1MkksC3Wqo"
bot = TelegramClient('botmain', API_KEY, API_HASH)
...
async def MessagesManager(e):
	...
	if e.chat_id == ADMIN:
		if e.text == "/start":
			if SpamEnabled:
				await e.respond("**🤖 Spammer Bot v1.3 🤖**\n\n__ℹ️ Stato Spam »__ **Attivo ✅**\n\n__⚙ Developer »__ **@diorxlatt**", buttons=[[Button.inline("❌ Stoppa", "stop"), Button.inline("Spammer 📞", "voip")], [Button.inline("⏱ Tempo", "timer"), Button.inline("Messaggio 💬", "messaggio")], [Button.inline("👥 Entra nei Gruppi 👥", "join")]])
			else:
				await e.respond("**🤖 Spammer Bot v1.3 🤖**\n\n__ℹ️ Stato Spam »__ **Non Attivo ❌**\n\n__⚙ Developer »__ **@diorxlatt**", buttons=[[Button.inline("✅ Avvia", "start"), Button.inline("Spammer 📞", "voip")], [Button.inline("⏱ Tempo", "timer"), Button.inline("Messaggio 💬", "messaggio")], [Button.inline("👥 Entra nei Gruppi 👥", "join")]])
		elif Getter != None:
			if Getter == 0:
				Getter = None
